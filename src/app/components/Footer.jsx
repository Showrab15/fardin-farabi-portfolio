  ...
  const socialMedia = [
    {
      name: "LinkedIn",
      icon: Linkedin,
      href: "https://www.linkedin.com/in/fardin-farabi-84b1462a5?",
...

    {
      name: "Instagram",
      icon: Instagram,
      href: "https://www.instagram.com/ui.fardin?igsh=azJwenRwMDdneGc0&utm_source=ig_contact_invite",
          ...
          <div className="lg:col-span-4">
            <div className="mb-6">
              ...
              <p className="text-gray-400 text-sm  leading-relaxed max-w-sm">
                Crafting beautiful digital experiences through thoughtful UI/UX
            ...
            <div className="space-y-3">
              <p className="flex items-center gap-3 text-gray-400 hover:text-[#DDFF00] transition-colors duration-300 group">
              ...
              <div className="flex items-center gap-3 text-gray-400 hover:text-[#DDFF00] transition-colors duration-300 group">
                ...
                <span className="hover:text-[#DDFF00] transition-colors duration-300 group text-sm leading-relaxed">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                ...
                >
                  <ArrowUp
                    className={`w-4 h-3 rotate-45 ${loading ? "animate-pulse" : ""}`}
                  />
                </button>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            <div className="flex gap-6">
              <a
                href="#"
                className="text-gray-500 hover:text-[#DDFF00] transition-colors duration-300 text-sm"
              >
                Privacy
              </a>
              <a
